...
//        [left setBackgroundColor:[UIColor blueColor]];
        ...
        [left addTarget:self action:@selector(missVC) forControlEvents:UIControlEventTouchUpInside];
        ...
        //        UIBarButtonItem *backButton = [[UIBarButtonItem alloc]initWithBarButtonSystemItem:UIBarButtonSystemItemCancel target:self action:@selector(missVC)];
...
//    _userlocation = [NSString stringWithFormat:@"%@ %@ %@",[addressDictionary objectForKey:(id)kABPersonAddressStateKey],[addressDictionary objectForKey:(id)kABPersonAddressCityKey],[addressDictionary objectForKey:@"SubLocality"]];
    _userlocation  =[NSString stringWithFormat:@"%@",[addressDictionary objectForKey:(id)kABPersonAddressCityKey]];
